...
export default async function page({ params }) {
    ...
    return (
        <div className="min-h-screen">
            ...
            <Image quality={100} className="w-full" src={'/room_iran.jpg'} width={200} height={100} alt="room_iran" />
            <div className=" px-2 py-4 flex flex-col gap-y-1">
                {room.map((i, index) => (
                    <Link href={`/${locale}/Commerce/${i.cityId}`} key={index} className="p-2 bg-white rounded-md flex flex-row gap-x-2 items-center">
                        <Image quality={100} className="" width={50} src={'/room_logo.png'} height={50} alt="room" />
