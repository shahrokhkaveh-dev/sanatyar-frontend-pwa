...
export default function FileInput({ name, data, setData }) {
    ...
    return (
        <div className="flex flex-row gap-x-3.5 items-center">
            <label htmlFor={name} className="w-fit text-nowrap text-base font-bold">{locale === "fa" ? "پیوست" : locale === "ar" ? "المرفق" : locale === "tr" ? "Ek" : "Attachment"}: </label>
